...
template <typename T>
class DirichletInfo_POMCP: public DirichletInfo<T, boost::unordered_map<T, double> > {
};

class NormalGammaInfo_POMCP: public boost::unordered_map<size_t, NormalGammaInfo> {
};
